...
```bash
mkdir -p ~/.gemini/antigravity-cli/skills && git clone -b skill https://github.com/tr1xx-tech/claude-to-gemini-converter.git ~/.gemini/antigravity-cli/skills/claude-to-gemini
```
---
